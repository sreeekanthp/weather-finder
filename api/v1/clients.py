...
class OpenWeatherMapWeatherClient(BaseOpenWeatherMapClient):
    ...
    def get_url(self, city_id):
        return f"{settings.OPEN_WEATHER_API_BASE_URL}weather?id={city_id}&appid={self.api_key}&units=metric"
...
class OpenWeatherMapCityListClient(BaseOpenWeatherMapClient):
    ...
    def get_url(self, query):
        return f"{settings.OPEN_WEATHER_API_BASE_URL}find?q={query}&appid={self.api_key}"
